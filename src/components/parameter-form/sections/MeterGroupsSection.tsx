                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            form.updateMeterGroupMeters(group.id, selected);
                          }}
                          className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ba0c2f] focus:border-transparent min-h-[120px] bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                          size={5}
                        >
                          {(form.meterList?.meters || []).map((m) => (
                          ...
                          <div className="mt-2">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {group.meters.map((m) => (
                                <span
                                  key={m}
                                  className="px-2 py-0.5 text-xs bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded border border-red-200 dark:border-red-800"
                                >
                                  {m}
                                </span>
                              ))}
